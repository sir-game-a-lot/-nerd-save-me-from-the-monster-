...
public class tk2dUIToggleButtonGroup : MonoBehaviour
{
    ...
    /// </summary>
    [SerializeField]
    private blaze2dUIToggleButton[] toggleBtns;

    public blaze2dUIToggleButton[] ToggleBtns
    {
    ...
    private blaze2dUIToggleButton selectedToggleButton;

    /// <summary>
    /// Currently selected toggle button
    /// </summary>
    public blaze2dUIToggleButton SelectedToggleButton
    {
    ...
    {
        foreach (blaze2dUIToggleButton toggleBtn in toggleBtns)
        {
            if (toggleBtn != null)
            {
    ...
    /// </summary>
    public void AddNewToggleButtons(blaze2dUIToggleButton[] newToggleBtns)
    {
    ...
    {
        blaze2dUIToggleButton newToggleBtn = null;
    ...
    private void ButtonToggle(blaze2dUIToggleButton toggleButton)
    {
        if (toggleButton == null || toggleButton.IsOn)
        {
            foreach (blaze2dUIToggleButton tempToggleBtn in toggleBtns)
            {
    ...
    {
        selectedIndex = -1;
        blaze2dUIToggleButton tempToggleBtn;
