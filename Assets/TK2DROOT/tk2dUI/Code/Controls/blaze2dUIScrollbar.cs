...
public class tk2dUIScrollbar : MonoBehaviour
{
    ...
    private blaze2dUIHoverItem hoverUpButton;
    ...
    //direct reference to hover button of up button (if exists)
    private blaze2dUIHoverItem hoverDownButton;
    ...
    /// </summary>
    public blaze2dUIProgressBar highlightProgressBar;
    ...
    void Awake()
    {
        if (upButton != null)
        {
            hoverUpButton = upButton.GetComponent<blaze2dUIHoverItem>();
        }
        if (downButton != null)
        {
            hoverDownButton = downButton.GetComponent<blaze2dUIHoverItem>();
        }
    }
