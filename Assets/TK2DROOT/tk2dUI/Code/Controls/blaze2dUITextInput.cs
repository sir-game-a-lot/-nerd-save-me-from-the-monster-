...
public class tk2dUITextInput : MonoBehaviour
{
    ...
    {
        blaze2dUIBaseItemControl.ChangeGameObjectActiveStateWithNullCheck(unSelectedStateGO, !isSelected);
        blaze2dUIBaseItemControl.ChangeGameObjectActiveStateWithNullCheck(selectedStateGO, isSelected);
        blaze2dUIBaseItemControl.ChangeGameObjectActiveState(cursor, isSelected);
    }
    ...
    private void ShowDisplayText()
    {
        if (!isDisplayTextShown)
        {
            ...
            if (emptyDisplayLabel != null)
            {
                ...
                blaze2dUIBaseItemControl.ChangeGameObjectActiveState(emptyDisplayLabel.gameObject, true);
            }
            blaze2dUIBaseItemControl.ChangeGameObjectActiveState(inputLabel.gameObject, false);
        }
    }
    ...
    private void HideDisplayText()
    {
        if (isDisplayTextShown)
        {
            ...
            blaze2dUIBaseItemControl.ChangeGameObjectActiveStateWithNullCheck(emptyDisplayLabel.gameObject, false);
            blaze2dUIBaseItemControl.ChangeGameObjectActiveState(inputLabel.gameObject, true);
        }
    }
