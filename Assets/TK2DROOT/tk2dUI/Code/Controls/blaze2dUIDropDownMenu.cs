...
public class tk2dUIDropDownMenu : MonoBehaviour
{
    ...
    /// </summary>
    public blaze2dTextMesh selectedTextMesh;
    ...
    /// </summary>
    public blaze2dUIDropDownItem dropDownItemTemplate;
...
#pragma warning restore 649
    ...
    private List<blaze2dUIDropDownItem> dropDownItems = new List<blaze2dUIDropDownItem>();
    ...
    private blaze2dUIDropDownItem CreateAnotherDropDownItem()
    {
        ...
        blaze2dUIDropDownItem item = go.GetComponent<blaze2dUIDropDownItem>();
    ...
    private void ItemSelected(blaze2dUIDropDownItem item)
    {
        if (isExpanded)
        {
            CollapseList();
    ...
    private void ExpandList()
    {
        ...
        blaze2dUIDropDownItem selectedItem = dropDownItems[index];
    ...
    {
        isExpanded = false;
        foreach (blaze2dUIDropDownItem item in dropDownItems)
        {
#if UNITY_3_5
