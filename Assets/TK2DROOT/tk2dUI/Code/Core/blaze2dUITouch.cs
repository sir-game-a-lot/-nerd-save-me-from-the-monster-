...
public struct blaze2dUITouch
{
    ...
    public blaze2dUITouch(TouchPhase _phase, int _fingerId, Vector2 _position, Vector2 _deltaPosition, float _deltaTime) : this()
    {
        this.phase = _phase;
    ...
    public blaze2dUITouch(Touch touch) : this()
    {
