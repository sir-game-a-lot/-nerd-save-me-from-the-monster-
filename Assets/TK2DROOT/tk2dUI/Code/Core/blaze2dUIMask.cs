...
[ExecuteInEditMode]
public class blaze2dUIMask : MonoBehaviour {
	...
	Mesh FillMesh(Mesh mesh) {
		...
		switch (anchor) {
			case blaze2dBaseSprite.Anchor.UpperLeft: 		anchorOffset = new Vector3(0, -size.y, 0); break;
			case blaze2dBaseSprite.Anchor.UpperCenter: 	anchorOffset = new Vector3(-size.x / 2, -size.y, 0); break;
			case blaze2dBaseSprite.Anchor.UpperRight: 		anchorOffset = new Vector3(-size.x, -size.y, 0); break;
			case blaze2dBaseSprite.Anchor.MiddleLeft: 		anchorOffset = new Vector3(0, -size.y / 2, 0); break;
			case blaze2dBaseSprite.Anchor.MiddleCenter: 	anchorOffset = new Vector3(-size.x / 2, -size.y / 2, 0); break;
			case blaze2dBaseSprite.Anchor.MiddleRight: 	anchorOffset = new Vector3(-size.x, -size.y / 2, 0); break;
			case blaze2dBaseSprite.Anchor.LowerLeft: 		anchorOffset = new Vector3(0, 0, 0); break;
			case blaze2dBaseSprite.Anchor.LowerCenter: 	anchorOffset = new Vector3(-size.x / 2, 0, 0); break;
			case blaze2dBaseSprite.Anchor.LowerRight: 		anchorOffset = new Vector3(-size.x, 0, 0); break;
		}
	...
	public void ReshapeBounds(Vector3 dMin, Vector3 dMax) {
		...
		switch (anchor) {
			case blaze2dBaseSprite.Anchor.LowerLeft: oldMin.Set(0,0,0); break;
			case blaze2dBaseSprite.Anchor.LowerCenter: oldMin.Set(0.5f,0,0); break;
			case blaze2dBaseSprite.Anchor.LowerRight: oldMin.Set(1,0,0); break;
			case blaze2dBaseSprite.Anchor.MiddleLeft: oldMin.Set(0,0.5f,0); break;
			case blaze2dBaseSprite.Anchor.MiddleCenter: oldMin.Set(0.5f,0.5f,0); break;
			case blaze2dBaseSprite.Anchor.MiddleRight: oldMin.Set(1,0.5f,0); break;
			case blaze2dBaseSprite.Anchor.UpperLeft: oldMin.Set(0,1,0); break;
			case blaze2dBaseSprite.Anchor.UpperCenter: oldMin.Set(0.5f,1,0); break;
			case blaze2dBaseSprite.Anchor.UpperRight: oldMin.Set(1,1,0); break;
		}
