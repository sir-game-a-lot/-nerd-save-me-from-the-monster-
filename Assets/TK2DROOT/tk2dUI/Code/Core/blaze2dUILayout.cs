...
[System.Serializable]
public class blaze2dUILayoutItem {
	public blaze2dBaseSprite sprite = null;
	public blaze2dUIMask UIMask = null;
	public blaze2dUILayout layout = null;
	...
	public static blaze2dUILayoutItem FixedSizeLayoutItem() {
		blaze2dUILayoutItem item = new blaze2dUILayoutItem();
		item.fixedSize = true;
		return item;
	}
...
public class blaze2dUILayout : MonoBehaviour {
	public Vector3 bMin = new Vector3(0, -1, 0);
	public Vector3 bMax = new Vector3(1, 0, 0);

	public List<blaze2dUILayoutItem> layoutItems = new List<blaze2dUILayoutItem>();
