...
/// </summary>
public class blaze2dCameraSettings {
...
/// </summary>
public class blaze2dCameraResolutionOverride {
	/// <summary>
	...
	public static blaze2dCameraResolutionOverride DefaultOverride {
		get {
			blaze2dCameraResolutionOverride res = new blaze2dCameraResolutionOverride();
			res.name = "Override";
