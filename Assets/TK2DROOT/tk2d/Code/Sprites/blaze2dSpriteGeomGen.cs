...
public static class blaze2dSpriteGeomGen
{
	// Common
	...
	public static Vector2 GetAnchorOffset( blaze2dBaseSprite.Anchor anchor, float width, float height ) {
	...
	// Sprite
	public static void GetSpriteGeomDesc(out int numVertices, out int numIndices, blaze2dSpriteDefinition spriteDef)
	{
		numVertices = spriteDef.positions.Length;
		numIndices = spriteDef.indices.Length;
	}

	public static void SetSpriteGeom(Vector3[] pos, Vector2[] uv, Vector3[] norm, Vector4[] tang, int offset, blaze2dSpriteDefinition spriteDef, Vector3 scale)
	{
	...
	public static void SetSpriteIndices(int[] indices, int offset, int vStart, blaze2dSpriteDefinition spriteDef)
	{
	...
	public static void GetClippedSpriteGeomDesc(out int numVertices, out int numIndices, blaze2dSpriteDefinition spriteDef)
	{
	...
	public static void SetClippedSpriteGeom( Vector3[] pos, Vector2[] uv, int offset, out Vector3 boundsCenter, out Vector3 boundsExtents, blaze2dSpriteDefinition spriteDef, Vector3 scale, Vector2 clipBottomLeft, Vector2 clipTopRight, float colliderOffsetZ, float colliderExtentZ )
	{
		...
		if (spriteDef.positions.Length == 4)
		{
			...
			if (spriteDef.flipped == blaze2dSpriteDefinition.FlipMode.Tk2d)
			{
			...
			else if (spriteDef.flipped == blaze2dSpriteDefinition.FlipMode.TPackerCW)
			{
				Vector2 v0 = new Vector2(Mathf.Lerp(spriteDef.uvs[0].x, spriteDef.uvs[3].x, fracBottomLeft.y),
				                         Mathf.Lerp(spriteDef.uvs[0].y, spriteDef.uvs[3].y, fracBottomLeft.x));
				Vector2 v1 = new Vector2(Mathf.Lerp(spriteDef.uvs[0].x, spriteDef.uvs[3].x, fracTopRight.y),
	...
	public static void SetClippedSpriteIndices( int[] indices, int offset, int vStart, blaze2dSpriteDefinition spriteDef)
	{
		if (spriteDef.positions.Length == 4)
		{
	...
	public static void GetSlicedSpriteGeomDesc(out int numVertices, out int numIndices, blaze2dSpriteDefinition spriteDef, bool borderOnly)
	{
		if (spriteDef.positions.Length == 4)
		{
			numVertices = 16;
	...
	public static void SetSlicedSpriteGeom(Vector3[] pos, Vector2[] uv, int offset, out Vector3 boundsCenter, out Vector3 boundsExtents, blaze2dSpriteDefinition spriteDef, Vector3 scale, Vector2 dimensions, Vector2 borderBottomLeft, Vector2 borderTopRight, blaze2dBaseSprite.Anchor anchor, float colliderOffsetZ, float colliderExtentZ)
	{
		boundsCenter = Vector3.zero;
		boundsExtents = Vector3.zero;
		if (spriteDef.positions.Length == 4)
	...
	public static void SetSlicedSpriteIndices(int[] indices, int offset, int vStart, blaze2dSpriteDefinition spriteDef, bool borderOnly)
	{
		if (spriteDef.positions.Length == 4)
		{
	...
	public static void GetTiledSpriteGeomDesc(out int numVertices, out int numIndices, blaze2dSpriteDefinition spriteDef, Vector2 dimensions)
	{
	...
	public static void SetTiledSpriteGeom(Vector3[] pos, Vector2[] uv, int offset, out Vector3 boundsCenter, out Vector3 boundsExtents, blaze2dSpriteDefinition spriteDef, Vector3 scale, Vector2 dimensions, blaze2dBaseSprite.Anchor anchor, float colliderOffsetZ, float colliderExtentZ)
	{
		boundsCenter = Vector3.zero;
		boundsExtents = Vector3.zero;
	...
	public static void SetTiledSpriteIndices(int[] indices, int offset, int vStart, blaze2dSpriteDefinition spriteDef, Vector2 dimensions)
	{
		int numVertices;
		int numIndices;
	...
	public static void SetSpriteDefinitionMeshData(Vector3[] pos, int[] indices, int posOffset, int indicesOffset, int vStart, blaze2dSpriteDefinition spriteDef, Matrix4x4 mat, Vector3 baseScale)
	{
