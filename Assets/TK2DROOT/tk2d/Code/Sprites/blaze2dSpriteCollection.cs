...
[System.Serializable]
public class blaze2dSpriteColliderIsland
{
	...
	public void CopyFrom(blaze2dSpriteColliderIsland src)
	{
	...
	public bool CompareTo(blaze2dSpriteColliderIsland src)
	{
...
[System.Serializable]
public class blaze2dSpriteCollectionDefinition
{
    public enum Anchor
    {
		UpperLeft,
	...
	public blaze2dSpriteColliderIsland[] geometryIslands = new blaze2dSpriteColliderIsland[0];
	...
	public blaze2dSpriteColliderIsland[] polyColliderIslands;
	...
	public List<blaze2dSpriteDefinition.AttachPoint> attachPoints = new List<blaze2dSpriteDefinition.AttachPoint>();

	public void CopyFrom(blaze2dSpriteCollectionDefinition src)
	{
		name = src.name;
		...
		{
			polyColliderIslands = new blaze2dSpriteColliderIsland[src.polyColliderIslands.Length];
			for (int i = 0; i < polyColliderIslands.Length; ++i)
			{
				polyColliderIslands[i] = new blaze2dSpriteColliderIsland();
				polyColliderIslands[i].CopyFrom(src.polyColliderIslands[i]);
			}
		}
		else
		{
			polyColliderIslands = new blaze2dSpriteColliderIsland[0];
		}
		
		if (src.geometryIslands != null)
		{
			geometryIslands = new blaze2dSpriteColliderIsland[src.geometryIslands.Length];
			for (int i = 0; i < geometryIslands.Length; ++i)
			{
				geometryIslands[i] = new blaze2dSpriteColliderIsland();
				geometryIslands[i].CopyFrom(src.geometryIslands[i]);
			}
		}
		else
		{
			geometryIslands = new blaze2dSpriteColliderIsland[0];
		}

		attachPoints = new List<blaze2dSpriteDefinition.AttachPoint>(src.attachPoints.Count);
		foreach (blaze2dSpriteDefinition.AttachPoint srcAp in src.attachPoints) {
	...
	{
		// Reinitialize
		var tmpVar = new blaze2dSpriteCollectionDefinition();
		CopyFrom(tmpVar);
	}
	
	public bool CompareTo(blaze2dSpriteCollectionDefinition src)
	{
...
[System.Serializable]
public class blaze2dSpriteCollectionDefault
{
    public bool additive = false;
    public Vector3 scale = new Vector3(1,1,1);
	public blaze2dSpriteCollectionDefinition.Anchor anchor = blaze2dSpriteCollectionDefinition.Anchor.MiddleCenter;
	public blaze2dSpriteCollectionDefinition.Pad pad = blaze2dSpriteCollectionDefinition.Pad.Default;	
	
	public blaze2dSpriteCollectionDefinition.ColliderType colliderType = blaze2dSpriteCollectionDefinition.ColliderType.UserDefined;
}

[System.Serializable]
public class blaze2dSpriteSheetSource
{
    public enum Anchor
    {
		UpperLeft,
	...
	public void CopyFrom(blaze2dSpriteSheetSource src)
	{
		texture = src.texture;
		tilesX = src.tilesX;
		tilesY = src.tilesY;
	...
	public bool CompareTo(blaze2dSpriteSheetSource src)
	{
		if (texture != src.texture) return false;
...
[System.Serializable]
public class blaze2dSpriteCollectionFont
{
	public bool active = false;
	...
	public void CopyFrom(blaze2dSpriteCollectionFont src)
	{
		active = src.active;
		bmFont = src.bmFont;
		texture = src.texture;
...
[System.Serializable]
public class blaze2dSpriteCollectionPlatform
{
	public string name = "";
	public blaze2dSpriteCollection spriteCollection = null;
	public bool Valid { get { return name.Length > 0 && spriteCollection != null; } }
	public void CopyFrom(blaze2dSpriteCollectionPlatform source)
	{
		name = source.name;
...
public class blaze2dSpriteCollection : MonoBehaviour 
{
    ...
    // Deprecated fields
    [SerializeField] private blaze2dSpriteCollectionDefinition[] textures; 
    ...
    // new method
	public blaze2dSpriteSheetSource[] spriteSheets;

	public blaze2dSpriteCollectionFont[] fonts;
	public blaze2dSpriteCollectionDefault defaults;
    ...
    public blaze2dSpriteCollectionDefinition[] textureParams;
	...
	public blaze2dSpriteDefinition.PhysicsEngine physicsEngine = blaze2dSpriteDefinition.PhysicsEngine.Physics3D;
