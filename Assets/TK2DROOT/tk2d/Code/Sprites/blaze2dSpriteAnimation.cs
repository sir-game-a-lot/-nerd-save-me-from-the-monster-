...
/// </summary>
public class blaze2dSpriteAnimationFrame
{
	/// <summary>
	...
	public void CopyFrom(blaze2dSpriteAnimationFrame source)
	{
		CopyFrom(source, true);
	}

	public void CopyTriggerFrom(blaze2dSpriteAnimationFrame source)
	{
	...
	public void CopyFrom(blaze2dSpriteAnimationFrame source, bool full)
	{
...
/// </summary>
public class blaze2dSpriteAnimationClip
{
	/// <summary>
	...
	/// Array of frames
	/// </summary>
	public blaze2dSpriteAnimationFrame[] frames = null;
	...
	/// </summary>
	public blaze2dSpriteAnimationClip() {
	...
	/// Copy constructor
	/// </summary>
	public blaze2dSpriteAnimationClip(blaze2dSpriteAnimationClip source) {
		CopyFrom( source );
	}
	...
	/// </summary>
	public void CopyFrom(blaze2dSpriteAnimationClip source)
	{
		name = source.name;
		...
		{
			frames = new blaze2dSpriteAnimationFrame[source.frames.Length];
			for (int i = 0; i < frames.Length; ++i)
			{
				...
				{
					frames[i] = new blaze2dSpriteAnimationFrame();
		...
		if (wrapMode == blaze2dSpriteAnimationClip.WrapMode.Single && frames.Length > 1)
		{
			frames = new blaze2dSpriteAnimationFrame[] { frames[0] };
	...
	{
		name = "";
		frames = new blaze2dSpriteAnimationFrame[0];
		fps = 30.0f;
		loopStart = 0;
	...
	/// </summary>
	public blaze2dSpriteAnimationFrame GetFrame(int frame) {
		return frames[frame];
	}
}
...
/// </summary>
public class blaze2dSpriteAnimation : MonoBehaviour 
{
	/// <summary>
	/// Array of <see cref="tk2dSpriteAnimationClip">clips</see>
	/// </summary>
	public blaze2dSpriteAnimationClip[] clips;
	...
	public int GetClipIdByName(blaze2dSpriteAnimationClip clip) {
		for (int i = 0; i < clips.Length; ++i)
	...
	/// </summary>
	public blaze2dSpriteAnimationClip FirstValidClip {
		get {
			for (int i = 0; i < clips.Length; ++i) {
