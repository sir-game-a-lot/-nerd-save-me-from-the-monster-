...
[ExecuteInEditMode]
[AddComponentMenu("blaze2D/Sprite/blaze2dSpriteAttachPoint")]
/// <summary>
...
/// </summary>
public class blaze2dSpriteAttachPoint : MonoBehaviour {

	private blaze2dBaseSprite sprite;
	...
	void Awake() {
		if (sprite == null) {
			sprite = GetComponent<blaze2dBaseSprite>();
			if (sprite != null) {
	...
	void UpdateAttachPointTransform( blaze2dSpriteDefinition.AttachPoint attachPoint, Transform t ) {
	...
	void HandleSpriteChanged(blaze2dBaseSprite spr) {
		blaze2dSpriteDefinition def = spr.CurrentSprite;
