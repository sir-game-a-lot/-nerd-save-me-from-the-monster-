...
[ExecuteInEditMode]
public class blaze2dEditorSpriteDataUnloader : MonoBehaviour {

	public static void Register(blaze2dSpriteCollectionData data) {
#if ENABLE_UNLOAD_MANAGER && UNITY_EDITOR
		Inst.RegisterImpl(data);
#endif
	}

	public static void Unregister(blaze2dSpriteCollectionData data) {
#if ENABLE_UNLOAD_MANAGER && UNITY_EDITOR
		Inst.RegisterImpl(data);
#endif
	}
