...
/// </summary>
public class blaze2dPixelPerfectHelper : MonoBehaviour
{
	// All access to this object should be performed through inst.
	static blaze2dPixelPerfectHelper _inst = null;
	
	/// <summary>
	/// Global singleton instance.
	/// </summary>
	public static blaze2dPixelPerfectHelper inst 
	{
		get
		{
			if (_inst == null)
			{
				_inst = GameObject.FindObjectOfType(typeof(blaze2dPixelPerfectHelper)) as blaze2dPixelPerfectHelper;
				if (_inst == null)
				{
					return null;
				}
