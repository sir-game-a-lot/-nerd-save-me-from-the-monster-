...
/// </summary>
public class blaze2dClippedSprite : blaze2dBaseSprite
{
	Mesh mesh;
	Vector2[] meshUvs;
	...
	new protected void SetColors(Color32[] dest)
	{
		...
		{
			blaze2dSpriteGeomGen.SetSpriteColors (dest, 0, 4, _color, collectionInst.premultipliedAlpha);
		}
	}	
	...
	protected void SetGeometry(Vector3[] vertices, Vector2[] uvs)
	{
		...
		blaze2dSpriteGeomGen.SetClippedSpriteGeom( meshVertices, meshUvs, 0, out boundsCenter, out boundsExtents, sprite, _scale, _clipBottomLeft, _clipTopRight, colliderOffsetZ, colliderExtentZ );

		if (meshNormals.Length > 0 || meshTangents.Length > 0) {
			blaze2dSpriteGeomGen.SetSpriteVertexNormals(meshVertices, meshVertices[0], meshVertices[3], sprite.normals, sprite.tangents, meshNormals, meshTangents);
		}
	...
	public override void Build()
	{
		...
		blaze2dSpriteGeomGen.SetClippedSpriteIndices(indices, 0, 0, CurrentSprite);
