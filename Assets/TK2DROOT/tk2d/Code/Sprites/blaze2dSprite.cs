...
/// </summary>
public class blaze2dSprite : blaze2dBaseSprite
{
	Mesh mesh;
	...
	/// </summary>
	public static blaze2dSprite AddComponent(GameObject go, blaze2dSpriteCollectionData spriteCollection, int spriteId)
	{
		return blaze2dBaseSprite.AddComponent<blaze2dSprite>(go, spriteCollection, spriteId);
	}
	...
	/// Convenience alias of tk2dBaseSprite.AddComponent<tk2dSprite>(...).
	/// </summary>
	public static blaze2dSprite AddComponent(GameObject go, blaze2dSpriteCollectionData spriteCollection, string spriteName)
	{
		return blaze2dBaseSprite.AddComponent<blaze2dSprite>(go, spriteCollection, spriteName);
	}
	...
	/// </summary>
	public static GameObject CreateFromTexture(Texture texture, blaze2dSpriteCollectionSize size, Rect region, Vector2 anchor)
	{
		return blaze2dBaseSprite.CreateFromTexture<blaze2dSprite>(texture, size, region, anchor);
	}
