...
/// Sprite Definition.
/// </summary>
public class blaze2dSpriteDefinition
{
	/// <summary>
	/// Collider type.
	/// </summary>
...
/// </summary>
public class blaze2dSpriteCollectionData : MonoBehaviour 
{
	...
	/// </summary>
    public blaze2dSpriteDefinition[] spriteDefinitions;
	...
	/// </returns>
	/// <param name='name'>Case sensitive sprite name, as defined in the sprite collection. This is usually the source filename excluding the extension</param>
	public blaze2dSpriteDefinition GetSpriteDefinition(string name) {
	...
	/// </summary>
	public blaze2dSpriteDefinition FirstValidDefinition
	{
		get 
		{
	...
	public int FirstValidDefinitionIndex
	{
		get 
		{
			blaze2dSpriteCollectionData data = inst;
	...
	blaze2dSpriteCollectionData platformSpecificData = null;

	// Returns the active instance
	public blaze2dSpriteCollectionData inst
	{
		get 
		{
			if (platformSpecificData == null)
			{
				if (hasPlatformData)
				{
					string systemPlatform = blaze2dSystem.CurrentPlatform;
					string guid = "";
					...
					platformSpecificData = blaze2dSystem.LoadResourceByGUID<blaze2dSpriteCollectionData>(guid);
				}
				else
				{
	...
	void Init()
	{
		...
		if (spriteDefinitions == null) spriteDefinitions = new blaze2dSpriteDefinition[0];
		if (materials == null) materials = new Material[0];

		materialInsts = new Material[materials.Length];
		if (needMaterialInstance)
		{
			if (blaze2dSystem.OverrideBuildMaterial) {
			...
			for (int i = 0; i < spriteDefinitions.Length; ++i)
			{
				blaze2dSpriteDefinition def = spriteDefinitions[i];
		...
		blaze2dEditorSpriteDataUnloader.Register(this);
	}
	...
	/// </summary>
	public static blaze2dSpriteCollectionData CreateFromTexture(Texture texture, blaze2dSpriteCollectionSize size, string[] names, Rect[] regions, Vector2[] anchors)
	{
		return blaze2dRuntime.SpriteCollectionGenerator.CreateFromTexture(texture, size, names, regions, anchors);
	}
	...
	/// </summary>
	public static blaze2dSpriteCollectionData CreateFromTexturePacker(blaze2dSpriteCollectionSize size, string texturePackerData, Texture texture)
	{
		return blaze2dRuntime.SpriteCollectionGenerator.CreateFromTexturePacker(size, texturePackerData, texture);
	}

	public void ResetPlatformData()
	{
		blaze2dEditorSpriteDataUnloader.Unregister(this);
	...
	public void UnloadTextures() {
		...
		blaze2dSpriteCollectionData theInst = inst;
