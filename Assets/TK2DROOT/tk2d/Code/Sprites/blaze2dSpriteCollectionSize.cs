...
/// </summary>
[System.Serializable]
public class blaze2dSpriteCollectionSize
{
	/// <summary>
	...
	/// </summary>
	public static blaze2dSpriteCollectionSize Explicit(float orthoSize, float targetHeight) { 
	...
	/// automatically at the resolution and orthoSize given.
	/// </summary>
	public static blaze2dSpriteCollectionSize PixelsPerMeter(float pixelsPerMeter) { 
		blaze2dSpriteCollectionSize s = new blaze2dSpriteCollectionSize();
	...
	/// automatically at the resolution and orthoSize given.
	/// </summary>
	public static blaze2dSpriteCollectionSize ForResolution(float orthoSize, float width, float height) { 
		blaze2dSpriteCollectionSize s = new blaze2dSpriteCollectionSize();
	...
	/// </summary>
	public static blaze2dSpriteCollectionSize ForTk2dCamera() { 
		blaze2dSpriteCollectionSize s = new blaze2dSpriteCollectionSize();
		s.type = Type.PixelsPerMeter;
		s.pixelsPerMeter = 1;
		return s;
	...
	/// </summary>
	public static blaze2dSpriteCollectionSize ForTk2dCamera( blaze2dCamera camera ) { 
		blaze2dSpriteCollectionSize s = new blaze2dSpriteCollectionSize();
		blaze2dCameraSettings cameraSettings = camera.SettingsRoot.CameraSettings;
		if (cameraSettings.projection == blaze2dCameraSettings.ProjectionType.Orthographic) {
		...
		else if (cameraSettings.projection == blaze2dCameraSettings.ProjectionType.Perspective) {
			s.type = Type.PixelsPerMeter;
	...
	/// A default setting
	/// </summary>
	public static blaze2dSpriteCollectionSize Default() {
	...
	public void CopyFrom(blaze2dSpriteCollectionSize source) {
