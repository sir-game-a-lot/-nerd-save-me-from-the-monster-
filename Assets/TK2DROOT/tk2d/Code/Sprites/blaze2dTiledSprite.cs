...
/// </summary>
public class blaze2dTiledSprite : blaze2dBaseSprite
{
	Mesh mesh;
	Vector2[] meshUvs;
	...
	new protected void SetColors(Color32[] dest)
	{
		int numVertices;
		int numIndices;
		blaze2dSpriteGeomGen.GetTiledSpriteGeomDesc(out numVertices, out numIndices, CurrentSprite, dimensions);
		blaze2dSpriteGeomGen.SetSpriteColors (dest, 0, numVertices, _color, collectionInst.premultipliedAlpha);
	}
	...
	public override void Build()
	{
		...
		int numVertices;
		int numIndices;
		blaze2dSpriteGeomGen.GetTiledSpriteGeomDesc(out numVertices, out numIndices, spriteDef, dimensions);
		...
		blaze2dSpriteGeomGen.SetTiledSpriteGeom(meshVertices, meshUvs, 0, out boundsCenter, out boundsExtents, spriteDef, _scale, dimensions, anchor, colliderOffsetZ, colliderExtentZ);
		blaze2dSpriteGeomGen.SetTiledSpriteIndices(meshIndices, 0, 0, spriteDef, dimensions);
		...
		if (meshNormals.Length > 0 || meshTangents.Length > 0) {
			...
			blaze2dSpriteGeomGen.SetSpriteVertexNormals(meshVertices, meshVertexMin, meshVertexMax, spriteDef.normals, spriteDef.tangents, meshNormals, meshTangents);
		}
