...
/// </summary>
public abstract class blaze2dBaseSprite : MonoBehaviour, blaze2dRuntime.ISpriteCollectionForceBuild
{
	/// <summary>
	/// Anchor.
	...
	/// </summary>
	[SerializeField]
    private blaze2dSpriteCollectionData collection;

	/// <summary>
	/// Deprecation warning: the set accessor will be removed in a future version.
	/// Use <see cref="tk2dBaseSprite.SetSprite">SetSprite</see> when you need to switch sprite collection.
	/// </summary>
	public blaze2dSpriteCollectionData Collection 
	{ 
    ...
    protected blaze2dSpriteCollectionData collectionInst;
	...
	/// </summary>
	public event System.Action<blaze2dBaseSprite> SpriteChanged;
	...
	/// </summary>
	public void SetSprite(blaze2dSpriteCollectionData newCollection, int newSpriteId) {
	...
	/// </summary>
	public bool SetSprite(blaze2dSpriteCollectionData newCollection, string spriteName) {
	...
	{
		float s = 1.0f;
		blaze2dCamera cam = blaze2dCamera.CameraForLayer(gameObject.layer);
		if (cam != null)
		{
		...
		else if (Camera.main)
		{
			...
			else
			{
				...
				s = blaze2dPixelPerfectHelper.CalculateScaleForPerspectiveCamera(Camera.main.fieldOfView, zdist);
			}
	...
	/// </summary>
	public static T AddComponent<T>(GameObject go, blaze2dSpriteCollectionData spriteCollection, int spriteId) where T : blaze2dBaseSprite
	{
	...
	/// </summary>
	public static T AddComponent<T>(GameObject go, blaze2dSpriteCollectionData spriteCollection, string spriteName) where T : blaze2dBaseSprite
	{
	...
	/// </returns>
	public blaze2dSpriteDefinition GetCurrentSpriteDef()
	{
		InitInstance();
	...
	/// <see cref="tk2dSpriteDefinition"/> for the currently active sprite.
	/// </returns>
	public blaze2dSpriteDefinition CurrentSprite {
		get {
			InitInstance();
			return (collectionInst == null) ? null : collectionInst.spriteDefinitions[_spriteId];
		}
	...
	{
		blaze2dSpriteDefinition sprite = collectionInst.spriteDefinitions[_spriteId];

		if (sprite.physicsEngine == blaze2dSpriteDefinition.PhysicsEngine.Physics3D) {
			if (sprite.colliderType == blaze2dSpriteDefinition.ColliderType.Box && boxCollider == null)
			{
			...
			if (boxCollider != null)
			{
				if (sprite.colliderType == blaze2dSpriteDefinition.ColliderType.Box)
				{
				...
				else if (sprite.colliderType == blaze2dSpriteDefinition.ColliderType.Unset)
				{
		...
		else if (sprite.physicsEngine == blaze2dSpriteDefinition.PhysicsEngine.Physics2D) {
#if !(UNITY_3_5 || UNITY_4_0 || UNITY_4_0_1 || UNITY_4_1 || UNITY_4_2)
				if (sprite.colliderType == blaze2dSpriteDefinition.ColliderType.Box)
				{
				...
				else if (sprite.colliderType == blaze2dSpriteDefinition.ColliderType.Mesh)
				{
				...
				else if (sprite.colliderType == blaze2dSpriteDefinition.ColliderType.None) {
					// Turn of existing box collider
					if (boxCollider2D != null && boxCollider2D.enabled) {
						boxCollider2D.enabled = false;
					}
	...
	{
		blaze2dSpriteDefinition sprite = collectionInst.spriteDefinitions[_spriteId];
		if (sprite.colliderType == blaze2dSpriteDefinition.ColliderType.Unset)
		{
		...
		if (sprite.physicsEngine == blaze2dSpriteDefinition.PhysicsEngine.Physics3D) {
			...
			if ((NeedBoxCollider() || sprite.colliderType == blaze2dSpriteDefinition.ColliderType.Box) && meshCollider == null)
			{
				if (boxCollider == null)
				{
					boxCollider = gameObject.AddComponent<BoxCollider>();
			...
			else if (sprite.colliderType == blaze2dSpriteDefinition.ColliderType.Mesh && boxCollider == null)
			{
	...
	public void CreateSimpleBoxCollider() {
		...
		if (CurrentSprite.physicsEngine == blaze2dSpriteDefinition.PhysicsEngine.Physics3D) {
#if !(UNITY_3_5 || UNITY_4_0 || UNITY_4_0_1 || UNITY_4_1 || UNITY_4_2)
		...
		else if (CurrentSprite.physicsEngine == blaze2dSpriteDefinition.PhysicsEngine.Physics2D) {
#if !(UNITY_3_5 || UNITY_4_0 || UNITY_4_0_1 || UNITY_4_1 || UNITY_4_2)
			boxCollider = GetComponent<BoxCollider>();
			if (boxCollider != null) {
	...
	// blaze2dRuntime.ISpriteCollectionEditor
	...
	/// </summary>
	public static GameObject CreateFromTexture<T>(Texture texture, blaze2dSpriteCollectionSize size, Rect region, Vector2 anchor) where T : blaze2dBaseSprite
	{
		blaze2dSpriteCollectionData data = blaze2dRuntime.SpriteCollectionGenerator.CreateFromTexture(texture, size, region, anchor);
		if (data == null)
			return null;
		GameObject spriteGo = new GameObject();
		blaze2dBaseSprite.AddComponent<T>(spriteGo, data, 0);
		return spriteGo;
	}
}
