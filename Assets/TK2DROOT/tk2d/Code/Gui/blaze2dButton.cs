...
public class blaze2dButton : MonoBehaviour 
{
	/// <summary>
	...
	/// </summary>
	public delegate void ButtonHandlerDelegate(blaze2dButton source);
	...
	void Start () 
	{
		if (viewCamera == null)
		{
			...
			if (viewCamera == null && blaze2dCamera.Instance)
			{
				viewCamera = blaze2dCamera.Instance.camera;
			}
