...
public static class blaze2dTextGeomGen
{
	public class GeomData
	{
		internal blaze2dTextMeshData textMeshData = null;
		internal blaze2dFontData fontInst = null;
	...
	public static GeomData Data(blaze2dTextMeshData textMeshData, blaze2dFontData fontData, string formattedText) {
	...
	{
		blaze2dTextMeshData data = geomData.textMeshData;
		blaze2dFontData _fontInst = geomData.fontInst;
	...
	{
		blaze2dTextMeshData data = geomData.textMeshData;
		blaze2dFontData fontInst = geomData.fontInst;
