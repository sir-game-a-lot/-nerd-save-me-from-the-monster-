...
/// </summary>
public class blaze2dFontData : MonoBehaviour
{
	...
	/// </summary>
	public blaze2dFontChar[] chars;
	
	[SerializeField]
	List<int> charDictKeys;
	[SerializeField]
	List<blaze2dFontChar> charDictValues;
	...
	blaze2dFontData platformSpecificData = null;
		...
		get 
		{
			if (platformSpecificData == null || platformSpecificData.materialInst == null)
			{
				if (hasPlatformData)
				{
					...
					platformSpecificData = blaze2dSystem.LoadResourceByGUID<blaze2dFontData>(guid);
				}
				else
				{
	...
	void Init()
	{
		if (needMaterialInstance)
		{
			if (spriteCollection)
			{
				blaze2dSpriteCollectionData spriteCollectionInst = spriteCollection.inst;
	...
	/// 
	/// </summary>
	public Dictionary<int, blaze2dFontChar> charDict;
	...
	public void InitDictionary()
	{
		...
		{
			charDict = new Dictionary<int, blaze2dFontChar>(charDictKeys.Count);
	...
	/// </summary>
	public void SetDictionary(Dictionary<int, blaze2dFontChar> dict)
	{
		charDictKeys = new List<int>(dict.Keys);
		charDictValues = new List<blaze2dFontChar>();
		for (int i = 0; i < charDictKeys.Count; ++i)
		{
